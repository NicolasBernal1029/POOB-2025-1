...
public class Hole{
     ...
     */
    public Hole(int xPosition, int yPosition, int maxParticles){
        this.diameter = 30;
    ...
    public int getAbsorbedParticles() {
        return absorbedParticles;
    }

    public boolean canAbsorbMore() {
        return absorbedParticles < maxParticles;
    }
